...
if(!$_POST) exit;
    ...
    $address = "academy_mauad@yahoo.com";
...
// Please Note, we cannot support this file package if modifications have been made below this line.
    ...
    $comments = $_POST['comments'];
		...
		if($error != '') { 
			echo '<div class="error_message">—Ã«¡ ﬁ„ »„—«Ã⁄… „⁄·Ê„« ﬂ Ê’ÕÕ «·√Œÿ«¡';
		...
		if(get_magic_quotes_gpc()) { $comments = stripslashes($comments); }
         ...
         // i.e. The standard subject will appear as, "„Õ„œ Ã„«·"
		...
		if(mail($address, $e_subject, $msg, "From: $email\r\nReturn-Path: $email\r\n")) {
		 ...
		 echo "<h1>·ﬁœ  „ ≈—”«· «·»—Ìœ »‰Ã«Õ</h1>";
		 echo "<p>‘ﬂ—« ·ﬂ <strong>$name</strong>, ·ﬁœ  „ ≈—”«· —”«· ﬂ »‰Ã«Õ</p>";
		 echo "</div>";
		 echo "</fieldset>";
